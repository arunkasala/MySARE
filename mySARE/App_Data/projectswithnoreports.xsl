...
<xsl:template match="/">
   <p>
     ...
     <span class="pagetitle">Projects with Missing Reports</span><br/>	  
  ...
  <br/><br/>
	<br/>
	<a href="?do=sendpicall&amp;reportStatus=3">Send Call for Reports to PIs</a>
	<br/>Click project number to edit project information.
	<br/>
