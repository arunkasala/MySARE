...
<xsl:template match="/">
   <p>
     ...
     <span class="pagetitle">Unretrieved Projects</span><br/>	  
	...
	<p>
		<span>Unretrieved Projects can be searched by entering the project number in the field below and clicking Search. If the project number is empty, clicking Search will display all unretrieved project(s).</span><br/>
	</p>
   <form action="?do=searchunclaimproj" method="post" name="unclaimProjectSearch">
     <table style="text-align: left; width: 100%;" border="0" cellpadding="4" cellspacing="0"><tablebody>
       <tr>
         Project Number: 
		 <td><input name="Query" type="text" size="20" maxlength="20" value="{$searchString}"/></td>
       </tr>	 
     </tablebody></table>
  ...
  <br/><br/>
	<br/>
	<a href="?do=sendpicall&amp;reportStatus=0">Send Call for Reports to PIs</a>
