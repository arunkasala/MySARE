...
<xsl:template match="/">
   <p>
     <span class="pagetitle">Search SARE Projects</span><br/>
 ...
 <input name="Submit" type="submit" value="Search"/>
  ...
  <tbody>
    ...
    <tr class="r1">
      ...
      <td><a href="?do=viewProj&amp;pn={@projNum}"><xsl:value-of select="@projNum"/></a></td>
      <td><a href="?do=viewProj&amp;pn={@projNum}"><xsl:value-of select="title"/></a>
