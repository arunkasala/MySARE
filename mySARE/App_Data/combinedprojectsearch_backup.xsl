      ...
      <xsl:choose>
            ...
            <xsl:when test="$count &lt; $thispage">
              <xsl:choose>
                <xsl:when test="$count=1">
					<xsl:choose>
						<xsl:when test="profilecategory">
							<a href="?do=profileSearch&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$count}">
								<xsl:value-of select="$count"/>
							</a>
						</xsl:when>
						<xsl:otherwise>
							<a href="?do=searchProj&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$count}">
								<xsl:value-of select="$count"/>
							</a>
						</xsl:otherwise>
					</xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <xsl:if test="$thispage &gt; 1">
			  <!-- <a href="?do=searchProj&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$thispage - 1}">&lt;&lt; Previous</a>&#160;&#160; -->
			  
			  <xsl:choose>
						<xsl:when test="profilecategory">
							<a href="?do=profileSearch&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$thispage - 1}">&lt;&lt; Previous</a>&#160;&#160;
						</xsl:when>
						<xsl:otherwise>
							<a href="?do=searchProj&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$thispage - 1}">&lt;&lt; Previous</a>&#160;&#160;
						</xsl:otherwise>
          ...
          <xsl:if test="$thispage &lt; $lastpage">&#160;&#160;
			  <!-- <a href="?do=searchProj&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$thispage + 1}">Next &gt;&gt;</a> -->

			  <xsl:choose>
				  <xsl:when test="profilecategory">
					  <a href="?do=profileSearch&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$thispage + 1}">Next &gt;&gt;</a>
				  </xsl:when>
				  <xsl:otherwise>
					  <a href="?do=searchProj&amp;q={$searchString}&amp;region={$searchRegion}&amp;projType={$searchType}&amp;page={$thispage + 1}">Next &gt;&gt;<xsl:value-of select="profilecategory[@name]"/></a>
				  </xsl:otherwise>
			  </xsl:choose>
